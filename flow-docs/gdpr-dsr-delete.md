...
|Feed attività ||Cmdlet per PowerApps||
|Processi utente|| ||
...
La procedura seguente descrive le funzioni amministrative esistenti per gestire le richieste di eliminazione per il regolamento GDPR.
